...
<main>
    ...
    <div class="container">
        ...
        <form action="{{ route('ratingUsersDisplay') }}" id="search" method="GET"></form>
        ...
        @foreach($rating_users as $rating_user)
            <nav class="navbar mt-4 btn btn-outline-success rounded-0 points-detail" data-user_id="{{ $rating_user['id'] }}">
